...
public class SwaggerDocumentationConfig {
	...
	ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("Mobile Eligible Offers")
				.description("Elysium - Motor de Reglas: Product Catalog Management").license("Apache 2.0")
				.licenseUrl("http://www.apache.org/licenses/LICENSE-2.0.html").termsOfServiceUrl("").version("1.0.0")
				.contact(new Contact("Freddy Ipanaque Castillo", "https://gitlab.com/fipanaque",
						"freddy.ipanaque@telefonica.com"))
				.build();
	}
	...
	public Docket customImplementation() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.telefonica.eom")).build()
