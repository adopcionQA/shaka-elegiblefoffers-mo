...
public class ProductsApiController implements ProductsApi {
    ...
    public ResponseEntity<ProductInstanceType> createProductInstance(@ApiParam(value = "The information required to create a product instance" ,required=true ) @RequestBody ProductInstanceRequestType productInstanceCreate,
    ...
    public ResponseEntity<ProductInstanceStatusType> modifyStatusOfSingleProductInstance(@ApiParam(value = "ID of the product instance",required=true ) @PathVariable("productId") String productId,
        ...
        @ApiParam(value = "Including the proof of access (using OAuth2.0 security model) to guarantee that the consumer has privileges to access the entity database"  ) @RequestHeader(value="Authorization", required=false) String authorization) {
        // do some magic!
        return new ResponseEntity<ProductInstanceStatusType>(HttpStatus.OK);
    }

    public ResponseEntity<List<ProductInstanceType>> retrieveProductInstances(@ApiParam(value = "If this API is used via a platform acting as a common entry point to different OBs, this identifier is used to route the request to the corresponding OB environment"  ) @RequestHeader(value="UNICA-ServiceId", required=false) String unICAServiceId,
        @ApiParam(value = "Identifier for the system originating the request"  ) @RequestHeader(value="UNICA-Application", required=false) String unICAApplication,
        @ApiParam(value = "Including the proof of access (using OAuth2.0 security model) to guarantee that the consumer has privileges to access the entity database"  ) @RequestHeader(value="Authorization", required=false) String authorization,
    ...
    public ResponseEntity<ProductInstanceType> retrieveSingleProductInstance(@ApiParam(value = "ID of the product instance",required=true ) @PathVariable("productId") String productId,
        @ApiParam(value = "If this API is used via a platform acting as a common entry point to different OBs, this identifier is used to route the request to the corresponding OB environment"  ) @RequestHeader(value="UNICA-ServiceId", required=false) String unICAServiceId,
        @ApiParam(value = "Identifier for the system originating the request"  ) @RequestHeader(value="UNICA-Application", required=false) String unICAApplication,
        @ApiParam(value = "Including the proof of access (using OAuth2.0 security model) to guarantee that the consumer has privileges to access the entity database"  ) @RequestHeader(value="Authorization", required=false) String authorization,
    ...
    public ResponseEntity<ProductInstanceStatusType> retrieveStatusOfSingleProductInstance(@ApiParam(value = "ID of the product instance",required=true ) @PathVariable("productId") String productId,
        @ApiParam(value = "If this API is used via a platform acting as a common entry point to different OBs, this identifier is used to route the request to the corresponding OB environment"  ) @RequestHeader(value="UNICA-ServiceId", required=false) String unICAServiceId,
        @ApiParam(value = "Identifier for the system originating the request"  ) @RequestHeader(value="UNICA-Application", required=false) String unICAApplication,
        @ApiParam(value = "Including the proof of access (using OAuth2.0 security model) to guarantee that the consumer has privileges to access the entity database"  ) @RequestHeader(value="Authorization", required=false) String authorization) {
        // do some magic!
    ...
    public ResponseEntity<ProductInstanceType> updateProductInstance(@ApiParam(value = "ID of the product instance",required=true ) @PathVariable("productId") String productId,
