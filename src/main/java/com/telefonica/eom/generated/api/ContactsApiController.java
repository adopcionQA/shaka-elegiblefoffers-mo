...
public class ContactsApiController implements ContactsApi {
    ...
    public ResponseEntity<List<ProductInstanceType>> retrieveContactProductInstances(@ApiParam(value = "ID of the contact (individual) whose products need to be fetched",required=true ) @PathVariable("contactId") String contactId,
