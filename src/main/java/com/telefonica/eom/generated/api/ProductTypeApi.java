...
@Api(value = "{productType}", description = "the {productType} API")
public interface ProductTypeApi {

    @ApiOperation(value = "Update existing product instance characteristic", notes = "", response = ProductInstanceType.class, tags={ "products", })
    @ApiResponses(value = { 
