...
public interface CustomersApi {
    ...
    @ApiOperation(value = "Create new customer product instance", notes = "", response = ProductInstanceType.class, tags={ "products of a customer", })
    @ApiResponses(value = { 
    ...
    @RequestMapping(value = "/customers/{customerId}/products",
        produces = { "application/json" }, 
        consumes = { "application/json" },
        method = RequestMethod.POST)
    ResponseEntity<ProductInstanceType> createCustomerProductInstance(@ApiParam(value = "ID of the customer the products will be attached to",required=true ) @PathVariable("customerId") String customerId,
        @ApiParam(value = "The information required to create a product instance" ,required=true ) @RequestBody ProductInstanceRequestType productInstanceCreate,
    ...
    @ApiOperation(value = "Retrieve list of products in inventory that belong to a customer", notes = "", response = ProductInstanceType.class, responseContainer = "List", tags={ "products of a customer", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "List of product instances provided", response = ProductInstanceType.class) })
    @RequestMapping(value = "/customers/{customerId}/products",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<List<ProductInstanceType>> retrieveCustomerProductInstances(@ApiParam(value = "ID of the customer whose products need to be fetched",required=true ) @PathVariable("customerId") String customerId,
        @ApiParam(value = "If this API is used via a platform acting as a common entry point to different OBs, this identifier is used to route the request to the corresponding OB environment"  ) @RequestHeader(value="UNICA-ServiceId", required=false) String unICAServiceId,
        @ApiParam(value = "Identifier for the system originating the request"  ) @RequestHeader(value="UNICA-Application", required=false) String unICAApplication,
        @ApiParam(value = "Including the proof of access (using OAuth2.0 security model) to guarantee that the consumer has privileges to access the entity database"  ) @RequestHeader(value="Authorization", required=false) String authorization,
    ...
    @ApiOperation(value = "Retrieve amount of products in inventory that belong to a customer", notes = "", response = Void.class, tags={ "products of a customer", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Amount of products of a customer", response = Void.class) })
    @RequestMapping(value = "/customers/{customerId}/products",
        method = RequestMethod.HEAD)
    ResponseEntity<Void> retrieveCustomerProductsAmount(@ApiParam(value = "ID of the customer whose products need to be fetched",required=true ) @PathVariable("customerId") String customerId,
         @ApiParam(value = "Type of the product instance", allowableValues = "MOBILE, LANDLINE, IPTV, CABLETV, BROADBAND, BUNDLE, SVA, SIM, DEVICE, BOLTON, DTH, STREAMINGTV") @RequestParam(value = "productType", required = false) String productType);
